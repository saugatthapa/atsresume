    ...
    <>
      ...
      <main className="container max-w-4xl py-12">
        ...
        <div className="mt-6 space-y-5 leading-8 text-slate-700">
          <p>JobResumeMatch provides AI-assisted resume suggestions. Resumes may contain personal data, so the product uses private token result URLs and noindex result pages.</p>
