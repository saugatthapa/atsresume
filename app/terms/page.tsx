    ...
    <>
      ...
      <main className="container max-w-4xl py-12">
        ...
        <div className="mt-6 space-y-5 leading-8 text-slate-700">
          ...
          <p>Paid exports are handled through secure checkout. Refunds and payment support are handled according to the checkout provider and published product terms.</p>
        </div>
      </main>
    </>
  );
